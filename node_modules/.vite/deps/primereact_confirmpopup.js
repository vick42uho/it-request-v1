...
// node_modules/primereact/confirmpopup/confirmpopup.esm.js
...
var classes = {
  root: function root(_ref) {
    var context = _ref.context, getPropValue = _ref.getPropValue;
...
var confirmPopup = function confirmPopup2() {
...
var ConfirmPopup = React.memo(React.forwardRef(function(inProps, ref) {
  ...
  var _ConfirmPopupBase$set = ConfirmPopupBase.setMetaData(metaData), ptm = _ConfirmPopupBase$set.ptm, cx = _ConfirmPopupBase$set.cx, isUnstyled = _ConfirmPopupBase$set.isUnstyled;
  ...
  var hide = function hide2(result) {
  ...
  var onEntered = function onEntered2() {
    ...
    if (defaultFocus === void 0 || defaultFocus === "accept") {
  ...
  var createContent = function createContent2() {
    ...
    return React.createElement("div", contentProps, icon, React.createElement("span", messageProps, message));
  };
  var createFooter = function createFooter2() {
    ...
    var content = React.createElement("div", footerProps, React.createElement(Button, rejectButtonProps), React.createElement(Button, acceptButtonProps));
  ...
  var createTemplateElement = function createTemplateElement2() {
    ...
    return React.createElement(CSSTransition, _extends({
      nodeRef: overlayRef
    }, transitionProps), React.createElement("div", rootProps, ObjectUtils.getJSXElement(inProps.content, templateElementProps)));
  };
  var createElement2 = function createElement3() {
    ...
    return React.createElement(CSSTransition, _extends({
      nodeRef: overlayRef
    }, transitionProps), React.createElement("div", rootProps, content, footer));
  };
...
//# sourceMappingURL=primereact_confirmpopup.js.map
