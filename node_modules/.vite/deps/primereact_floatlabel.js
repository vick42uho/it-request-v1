...
var FloatLabel = React.memo(React.forwardRef(function(inProps, ref) {
  ...
  var _FloatLabelBase$setMe = FloatLabelBase.setMetaData({
    props
  }), ptm = _FloatLabelBase$setMe.ptm, cx = _FloatLabelBase$setMe.cx, isUnstyled = _FloatLabelBase$setMe.isUnstyled;
  ...
  return React.createElement("span", rootProps, props.children);
}));
FloatLabel.displayName = "FloatLabel";
export {
  FloatLabel
};
//# sourceMappingURL=primereact_floatlabel.js.map
