...
import {
  ...
  InfoCircleIcon
} from "./chunk-G6NOMF5I.js";
import {
  Button
} from "./chunk-XVP3HBM4.js";
import {
  ProgressBar
} from "./chunk-ESLV5SFJ.js";
import {
  TimesCircleIcon
...
var PlusIcon = React.memo(React.forwardRef(function(inProps, ref) {
...
var UploadIcon = React2.memo(React2.forwardRef(function(inProps, ref) {
  var pti = IconBase.getPTI(inProps);
...
var UIMessage = React3.memo(React3.forwardRef(function(props, ref) {
  ...
  var createCloseIcon = function createCloseIcon2() {
    if (closable !== false) {
      ...
      return React3.createElement("button", buttonProps, _closeIcon2, React3.createElement(Ripple, null));
    }
    return null;
  };
  var createMessage = function createMessage2() {
    if (props.message) {
      ...
      return content || React3.createElement(React3.Fragment, null, iconContent, React3.createElement("span", summaryProps, summary), React3.createElement("span", detailProps, detail));
    }
    return null;
  };
  ...
  return React3.createElement("div", rootProps, React3.createElement("div", wrapperProps, message, closeIcon));
}));
...
var messageIdx = 0;
var Messages = React3.memo(React3.forwardRef(function(inProps, ref) {
  var mergeProps = useMergeProps();
  ...
  return React3.createElement("div", _extends3({
    ref: elementRef
  }, rootProps), React3.createElement(TransitionGroup_default, null, messagesState && messagesState.map(function(message, index) {
    var messageRef = React3.createRef();
    return React3.createElement(CSSTransition, _extends3({
      nodeRef: messageRef,
      key: message._pId
    }, transitionProps), React3.createElement(UIMessage, {
      hostName: "Messages",
      ref: messageRef,
      message,
...
var FileUpload = React4.memo(React4.forwardRef(function(inProps, ref) {
  ...
  var createChooseButton = function createChooseButton2() {
    ...
    var chooseIcon2 = IconUtils.getJSXIcon(icon, _objectSpread2({}, chooseIconProps), {
      props
    });
  ...
  var createAdvanced = function createAdvanced2() {
    ...
    if (!props.auto) {
      ...
      var uploadIcon2 = IconUtils.getJSXIcon(uploadOptions.icon || React4.createElement(UploadIcon, uploadIconProps), _objectSpread2({}, uploadIconProps), {
        props
      });
      ...
      var cancelIcon2 = IconUtils.getJSXIcon(cancelOptions.icon || React4.createElement(TimesIcon, cancelIconProps), _objectSpread2({}, cancelIconProps), {
        props
      });
  ...
  var createBasic = function createBasic2() {
    ...
    var label = props.auto ? chooseLabel : React4.createElement("span", labelProps, hasFiles ? filesState[0].name : chooseLabel);
    var chooseIconProps = mergeProps({
      className: cx("chooseIcon", {
